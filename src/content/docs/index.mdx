...
Run `html2rss-web` with Docker, create one generated feed with the demo token, then move to the real operator setup.
...
- moving to real deployment setup after first success
