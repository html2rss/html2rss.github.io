...
- **[Use automatic feed generation](/web-application/guides/use-automatic-feed-generation/)**: understand the normal direct page-URL workflow
- **[Use the included configs](/web-application/guides/use-included-configs/)**: fallback when the packaged catalog already covers your site
