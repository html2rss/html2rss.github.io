...
<Code code={`html2rss apply the_feed_config.yml --params id:42 foo:bar`} lang="bash" />
...
- **[Custom HTTP Requests](/ruby-gem/guides/custom-http-requests/)** - Using dynamic parameters in headers
