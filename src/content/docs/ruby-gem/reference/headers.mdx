...
You can also use dynamic parameters in your headers to pass values at runtime. See [Dynamic Parameters/ruby-gem/guides/dynamic-parameters/) for more information.
