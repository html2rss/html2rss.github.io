...
- **[Use automatic feed generation](/web-application/how-to/use-automatic-feed-generation/)**: create feeds from page URLs
- **[Use included configs](/web-application/how-to/use-included-configs/)**: use the built-in feed catalog as a fallback
