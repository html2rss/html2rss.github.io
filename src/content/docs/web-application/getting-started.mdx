...
1. **[Deployment & Production](/web-application/how-to/deployment/)**: the URLs of the feed become stable
2. **[Use automatic feed generation](/web-application/how-to/use-automatic-feed-generation/)**: understand the flow in more detail
...
1. **[Deployment & Production](/web-application/how-to/deployment/)**: convert the demo into a real operator setup
