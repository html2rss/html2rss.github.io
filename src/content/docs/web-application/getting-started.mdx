...
description: "Learn how to use html2rss-web to create RSS feeds from any website."
sidebar:
  order: 2
---

Ready to create RSS feeds? Choose your path below.
...
1. **Go to [html2rss-web](https://html2rss-web.herokuapp.com/)** (or your preferred instance)
2. **Enter a website URL** you want to create a feed for
3. **Click "Generate Feed"** and copy the RSS URL
4. **Add to your feed reader** (Feedly, Inoreader, etc.)
