...
Use the quickstart stack from [`html2rss-web/docker-compose.quickstart.yml`](https://github.com/html2rss/html2rss-web/blob/main/docker-compose.quickstart.yml).
...
- [Use the included configs](/web-application/guides/use-included-configs/)
