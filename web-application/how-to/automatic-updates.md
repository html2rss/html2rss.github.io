...
nav_order: 3
permalink: /web-application/how-to/automatic-updates
...
The `docker-compose.yml` in the [Getting Started guide]({{ '/web-application/tutorials' | relative_url }}) contains a service description for watchtower.
